...
namespace detail {
template <typename T> struct AlignasHelper { T mT; };
} // namespace detail
...
template <> struct AlignedElem<1> { MOZ_ALIGNED_DECL(1, uint8_t elem); };

template <> struct AlignedElem<2> { MOZ_ALIGNED_DECL(2, uint8_t elem); };

template <> struct AlignedElem<4> { MOZ_ALIGNED_DECL(4, uint8_t elem); };

template <> struct AlignedElem<8> { MOZ_ALIGNED_DECL(8, uint8_t elem); };

template <> struct AlignedElem<16> { MOZ_ALIGNED_DECL(16, uint8_t elem); };
