...
template <typename EnumTypeT> class EnumeratedIterator {
public:
...
template <typename EnumTypeT> class EnumeratedRange {
public:
...
// See bug 1614512.
template <typename EnumType>
constexpr detail::EnumeratedRange<EnumType>
MakeInclusiveEnumeratedRange(EnumType aBegin, EnumType aEnd) {
