...
public:
   ...
   * code (size_t).
   */
  MFBT_API Result<Span<const char>, size_t>
  BeginCompressing(Span<char> aWriteBuffer);
   ...
   */
  MFBT_API Result<Span<const char>, size_t>
  ContinueCompressing(Span<const char> aInput);
...
public:
   ...
   * (size_t).
   */
  MFBT_API Result<LZ4FrameDecompressionResult, size_t>
  Decompress(Span<char> aOutput, Span<const char> aInput);
