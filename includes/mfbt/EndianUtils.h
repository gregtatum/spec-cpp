...
template <typename T> struct Swapper<T, 2> {
...
template <typename T> struct Swapper<T, 4> {
  static T swap(T aValue) {
...
template <typename T> struct Swapper<T, 8> {
...
class EndianUtils {
  ...
  static void assertNoOverlap(const void *aDest, const void *aSrc,
                              size_t aCount) {
    DebugOnly<const uint8_t *> byteDestPtr =
  ...
  template <typename T> static void assertAligned(T *aPtr) {
...
template <Endianness ThisEndian> class Endian : private EndianUtils {
protected:
   ...
   */
  template <typename T>[[nodiscard]] static T swapToLittleEndian(T aValue) {
   ...
   */
  template <typename T>[[nodiscard]] static T swapToBigEndian(T aValue) {
  ...
  template <typename T>[[nodiscard]] static T swapToNetworkOrder(T aValue) {
   ...
   */
  template <typename T>[[nodiscard]] static T swapFromLittleEndian(T aValue) {
   ...
   */
  template <typename T>[[nodiscard]] static T swapFromBigEndian(T aValue) {
   ...
   * in network code.
   */
  template <typename T>[[nodiscard]] static T swapFromNetworkOrder(T aValue) {
...
private:
   ...
   */
  template <typename T> static T read(const void *aPtr) {
    union {
      T mVal;
      uint8_t mBuffer[sizeof(T)];
    } u;
   ...
   * endianness.
   */
  template <typename T> static void write(void *aPtr, T aValue) {
