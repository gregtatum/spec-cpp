...
#include "./Casting.h"   // for mozilla::AssertedCast
#include "./Likely.h"    // for MOZ_UNLIKELY
#include "./Maybe.h"     // for mozilla::Maybe
#include "./Span.h"      // for mozilla::Span
#include "./TextUtils.h" // for mozilla::IsAscii and via Latin1.h for
                         // encoding_rs_mem.h and MOZ_HAS_JSRUST.
#include "./Tuple.h"     // for mozilla::Tuple
#include "./Types.h"     // for MFBT_API
 ...
 */
inline mozilla::Tuple<size_t, size_t>
ConvertUtf16toUtf8Partial(mozilla::Span<const char16_t> aSource,
                          mozilla::Span<char> aDest) {
 ...
 * UnsafeConvertValidUtf8toUtf16() instead.
 */
inline mozilla::Maybe<size_t>
ConvertUtf8toUtf16WithoutReplacement(mozilla::Span<const char> aSource,
                                     mozilla::Span<char16_t> aDest) {
...
DecodeOneUtf8CodePointInline(const Utf8Unit aLeadUnit, Iter *aIter,
                             const EndIter &aEnd) {
