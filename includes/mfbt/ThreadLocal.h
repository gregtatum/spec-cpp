...
template <typename S> struct Helper { typedef uintptr_t Type; };

template <typename S> struct Helper<S *> { typedef S *Type; };
...
template <typename T> class ThreadLocalKeyStorage {
public:
...
template <typename T> class ThreadLocalNativeStorage {
public:
