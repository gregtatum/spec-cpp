...
template <typename To, typename From> inline To BitwiseCast(const From aFrom) {
  To temp;
...
template <typename From> class BoundsChecker<From, From, true> {
public:
  static bool checkBounds(const From aFrom) { return true; }
};

template <typename From, typename To> class BoundsChecker<From, To, true> {
public:
  static bool checkBounds(const From aFrom) {
...
template <typename From, typename To> inline bool IsInBounds(const From aFrom) {
