...
namespace mozilla::detail {
template <> struct UnusedZero<Failed> {
...
static constexpr Result<Ok, TestUnusedZeroEnum>
Task1UnusedZeroEnumErr(bool pass) {
  if (!pass) {
...
static constexpr Result<int, TestUnusedZeroEnum>
Task2UnusedZeroEnumErr(bool pass, int value) {
