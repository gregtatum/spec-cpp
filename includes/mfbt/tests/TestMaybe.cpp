...
private:
  ...
  operator=(const UncopyableUnmovableValue &aOther) = delete;
  UncopyableUnmovableValue(UncopyableUnmovableValue &&aOther) = delete;
  UncopyableUnmovableValue &
  operator=(UncopyableUnmovableValue &&aOther) = delete;
...
struct UncopyableValueLiteralType {
  ...
  operator=(UncopyableValueLiteralType &&) = default;
...
static bool TestBasicFeatures() {
  ...
  static_assert(
      std::is_same_v<const BasicValue &, decltype(mayValueCRef.ref())>,
      "ref() should return a const BasicValue&");
  MOZ_RELEASE_ASSERT(mayValueCRef.ptr() != nullptr);
  static_assert(
      std::is_same_v<const BasicValue *, decltype(mayValueCRef.ptr())>,
  ...
  static_assert(
      std::is_same_v<BasicValue *, decltype(Some(BasicValue()).ptr())>,
      "ptr() should return a BasicValue*");
  ...
  static_assert(
      std::is_same_v<const BasicValue &&, decltype(*MakeConstMaybe())>,
...
template <typename T> static void TestCopyMaybe() {
  {
...
template <typename T> static void TestMoveMaybe() {
  {
    MOZ_RELEASE_ASSERT(0 == sUndestroyedObjects);
...
static bool TestFunctionalAccessors() {
  ...
  static_assert(std::is_same_v<BasicValue, decltype(someValue.valueOrFrom(
                                               &MakeBasicValue))>,
  ...
  static_assert(std::is_same_v<BasicValue *, decltype(someValue.ptrOrFrom(
                                                 &MakeBasicValuePtr))>,
  ...
  static_assert(std::is_same_v<BasicValue &, decltype(someValue.refOrFrom(
                                                 &MakeBasicValueRef))>,
  ...
  MOZ_RELEASE_ASSERT(someValueCRef.valueOrFrom(&MakeBasicValue) ==
                     BasicValue(3));
  static_assert(std::is_same_v<BasicValue, decltype(someValueCRef.valueOrFrom(
                                               &MakeBasicValue))>,
                "valueOrFrom should return a BasicValue");
  ...
  static_assert(std::is_same_v<BasicValue, decltype(noneValue.valueOrFrom(
                                               &MakeBasicValue))>,
                "valueOrFrom should return a BasicValue");
  ...
  static_assert(std::is_same_v<BasicValue *, decltype(noneValue.ptrOrFrom(
                                                 &MakeBasicValuePtr))>,
                "ptrOrFrom should return a BasicValue*");
  ...
  static_assert(std::is_same_v<BasicValue &, decltype(noneValue.refOrFrom(
                                                 &MakeBasicValueRef))>,
                "refOrFrom should return a BasicValue&");
  ...
  MOZ_RELEASE_ASSERT(noneValueCRef.valueOrFrom(&MakeBasicValue) ==
                     BasicValue(9));
  static_assert(std::is_same_v<BasicValue, decltype(noneValueCRef.valueOrFrom(
                                               &MakeBasicValue))>,
                "valueOrFrom should return a BasicValue");
