...
template <typename T, MemoryOrdering Order> static void TestTypeWithOrdering() {
...
template <MemoryOrdering Order> static void TestEnumWithOrdering() {
...
template <MemoryOrdering Order> static void TestEnumClassWithOrdering() {
...
template <MemoryOrdering Order> static void TestBoolWithOrdering() {
