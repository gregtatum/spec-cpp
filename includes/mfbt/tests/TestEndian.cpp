...
template <typename T> void TestSingleSwap(T aValue, T aSwappedValue) {
...
template <typename T> void TestSingleNoSwap(T aValue, T aUnswappedValue) {
#if MOZ_LITTLE_ENDIAN()
...
#define WRAP_COPYTO(NAME)                                                      \
  template <typename T> void NAME(void *aDst, const T *aSrc, size_t aCount) {  \
...
#define WRAP_COPYFROM(NAME)                                                    \
  template <typename T> void NAME(T *aDst, const void *aSrc, size_t aCount) {  \
    NativeEndian::NAME<T>(aDst, aSrc, aCount);                                 \
  }
...
#define WRAP_IN_PLACE(NAME)                                                    \
  template <typename T> void NAME(T *aP, size_t aCount) {                      \
