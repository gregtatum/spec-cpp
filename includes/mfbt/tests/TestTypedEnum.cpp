...
#include <type_traits>
template <typename T> void RequireLiteralType() {
...
template <typename T> void RequireLiteralType(const T &) {
...
template <typename T> void TestNonConvertibilityForOneType() {
...
template <typename TypedEnum> void TestTypedEnumBasics() {
...
template <typename TypedEnum, typename T> void TestTilde(const T &aT) {
  typedef typename mozilla::detail::UnsignedIntegerTypeForEnum<TypedEnum>::Type
      UnsignedIntegerType;
...
template <typename TypedEnum> void TestTypedEnumBitField() {
...
template <typename EnumType, typename IntType> void TestIsNotTruncated() {
