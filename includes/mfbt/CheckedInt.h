...
template <typename IntegerType> struct IsSupportedPass2 {
...
template <> struct IsSupported<int8_t> { static const bool value = true; };

template <> struct IsSupported<uint8_t> { static const bool value = true; };

template <> struct IsSupported<int16_t> { static const bool value = true; };

template <> struct IsSupported<uint16_t> { static const bool value = true; };

template <> struct IsSupported<int32_t> { static const bool value = true; };

template <> struct IsSupported<uint32_t> { static const bool value = true; };

template <> struct IsSupported<int64_t> { static const bool value = true; };

template <> struct IsSupported<uint64_t> { static const bool value = true; };

template <> struct IsSupportedPass2<char> { static const bool value = true; };

template <> struct IsSupportedPass2<signed char> {
  static const bool value = true;
};

template <> struct IsSupportedPass2<unsigned char> {
  static const bool value = true;
};

template <> struct IsSupportedPass2<short> { static const bool value = true; };

template <> struct IsSupportedPass2<unsigned short> {
  static const bool value = true;
};

template <> struct IsSupportedPass2<int> { static const bool value = true; };

template <> struct IsSupportedPass2<unsigned int> {
  static const bool value = true;
};

template <> struct IsSupportedPass2<long> { static const bool value = true; };

template <> struct IsSupportedPass2<unsigned long> {
  static const bool value = true;
};

template <> struct IsSupportedPass2<long long> {
  static const bool value = true;
};

template <> struct IsSupportedPass2<unsigned long long> {
  static const bool value = true;
};
...
template <typename IntegerType> struct TwiceBiggerType<IntegerType, 8> {
  typedef UnsupportedType Type;
};

template <typename T> constexpr bool HasSignBit(T aX) {
...
template <typename T> constexpr T BinaryComplement(T aX) { return ~aX; }
...
template <typename T, typename U> constexpr bool IsInRange(U aX) {
  return IsInRangeImpl<T, U>::run(aX);
}

template <typename T> constexpr bool IsAddValid(T aX, T aY) {
...
template <typename T> constexpr bool IsSubValid(T aX, T aY) {
#if MOZ_HAS_BUILTIN_OP_OVERFLOW
  T dummy;
...
template <typename T> inline bool IsMulValid(T aX, T aY) {
#if MOZ_HAS_BUILTIN_OP_OVERFLOW
  T dummy;
...
template <typename T> constexpr bool IsDivValid(T aX, T aY) {
...
template <typename T> constexpr bool IsModValid(T aX, T aY) {
...
template <typename T> struct IsModValidImpl<T, true> {
  static constexpr bool run(T aX, T aY) {
    if (aX < 0) {
      return false;
    }
...
template <typename T, bool IsSigned = std::is_signed_v<T>> struct NegateImpl;

template <typename T> struct NegateImpl<T, false> {
...
template <typename T> struct NegateImpl<T, true> {
  static constexpr CheckedInt<T> negate(const CheckedInt<T> &aVal) {
...
public:
  ...
  template <typename U> friend class CheckedInt;

  template <typename U> constexpr CheckedInt<U> toChecked() const {
  ...
  template <typename U> constexpr CheckedInt &operator+=(U aRhs);
...
template <typename T, typename U> struct CastToCheckedIntImpl {
  typedef CheckedInt<T> ReturnType;
  static constexpr CheckedInt<T> run(U aU) { return aU; }
};

template <typename T> struct CastToCheckedIntImpl<T, CheckedInt<T>> {
